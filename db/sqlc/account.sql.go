...
SELECT id, owner, balance, currency, created_at, updated_at FROM accounts WHERE id = ?
`
...
SELECT id, owner, balance, currency, created_at, updated_at FROM accounts ORDER BY id LIMIT ?
`
